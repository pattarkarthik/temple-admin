export const newMemberFormFields = [
  ...
  { label: "பெயர்", name: "name", required: true, type: "text" },
  { label: "மனைவி பெயர்", name: "spouse_name", required: false, type: "text" },
  {
    label: "முகவரி வரி 1",
    name: "address_line_1",
    required: true,
...
export const commanYelamFormFields = [
  ...
  { label: "ஏல தொகை", name: "bid_amount", required: true, type: "number" },
];
